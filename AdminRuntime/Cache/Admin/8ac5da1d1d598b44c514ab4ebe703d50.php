            ...
            <!-- form start -->
                    <form action="<?php echo U('Admin/addRoleResource');?>" method="post" >
                        ...
                        <div class="box-footer">
                            <input type="hidden" value="<?php echo ($nodeIds); ?>" name="node_id" id="node_id">
...
<script type="text/javascript" src="/AdminResource/adminhome/component/zTree/js/jquery.ztree.core.min.js"></script>
<script type="text/javascript" src="/AdminResource/adminhome/component/zTree/js/jquery.ztree.excheck.min.js"></script>
