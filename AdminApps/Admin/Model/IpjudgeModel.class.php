...
class IpjudgeModel extends Model {
     ...
     * 分页数据集
     */
    public function selectIpjudgeByPage($Page) {
        $result = M('Ipjudge')->limit($Page->firstRow . ',' . $Page->listRows)->order('ip_id desc')->select();
        return $result;
    }
     ...
     * 获取用户表中的总条数
     */
    public function selectIpJudgeTotalSize() {
        $result = M('Ipjudge')->count();
        return $result;
    }
